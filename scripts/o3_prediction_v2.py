...
class _Weights_object():
    ...
    def __init__ ( self, \
                   ...
                   Normalization_Brightness_Temperatures_Min, \
                   Normalization_Brightness_Temperatures_Max, \
        ...
        self.bt_min = Normalization_Brightness_Temperatures_Min
        self.bt_max = Normalization_Brightness_Temperatures_Max
...
def _read_weights(weights_file=None):
    ...
    Normalization_Brightness_Temperatures_Min = file['Normalization_Brightness_Temperatures_Min'][:]
    Normalization_Brightness_Temperatures_Max = file['Normalization_Brightness_Temperatures_Max'][:]
    ...
    for i_lat in range ( 0, len(weights.lats) ):
        ...
        if len(ind_lat)>0:
            ...
            for i_obs in range(0, len(ind_lat)):
                ...
                thresh_min = np.where(features[ind_lat[i_obs],:]-weights.bt_min[:,i_lat]<0)[0]
                thresh_max = np.where(features[ind_lat[i_obs],:]-weights.bt_max[:,i_lat]>0)[0]
...
## =========================================================================
## Run main
# Call: python o3_prediction.py '/data/emls/l1b/v06.01/2024/279/MLS-Aura_L1BRADG_v06-01-c01_2024d279.h5' '/data/emls/l1b/v06.01/2024/279/MLS-Aura_L1BRADD_v06-01-c01_2024d279.h5' '/data/emls/l1b/v06.01/2024/279/MLS-Aura_L1BOA_v06-01-c01_2024d279.h5' '/users/fwerner/Documents/database/neural_network_weights/weights/v05-0x/MLS-Aura_ANN-O3_v05-0x-01_20241021.h5' '/users/fwerner/Documents/software/python/ann/test_data/MLS-Aura_O3_v06-01-NRT-18-c01_2024d279.h5'
## =========================================================================
...
## Revisions
## =========================================================================
## Revision 1.1  2024/10/21 fwerner
## changed feature outlier detection and added double precision for _tanh()
