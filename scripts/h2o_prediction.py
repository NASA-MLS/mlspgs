...
class _Weights_object():
    ...
    def __init__ ( self, \
                   ...
                   Weights_Hidden_Layer_3, \
                   Intercepts_Hidden_Layer_3, \
                   Weights_Hidden_Layer_4, \
                   Intercepts_Hidden_Layer_4, \
        ...
        self.w_l3 = Weights_Hidden_Layer_3
        self.i_l3 = Intercepts_Hidden_Layer_3
        self.w_l4 = Weights_Hidden_Layer_4
        self.i_l4 = Intercepts_Hidden_Layer_4
...
def _read_weights(weights_file=None):
    ...
    Weights_Hidden_Layer_3 = file['Weights_Hidden_Layer_3'][:]
    Intercepts_Hidden_Layer_3 = file['Intercepts_Hidden_Layer_3'][:]
    Weights_Hidden_Layer_4 = file['Weights_Hidden_Layer_4'][:]
    Intercepts_Hidden_Layer_4 = file['Intercepts_Hidden_Layer_4'][:]
...
def _define_precision(surfs=None):
    ...
    rmsd_ann = np.array([-9.99990000e+08, -9.99990000e+08, -9.99990000e+08, -9.99990000e+08,
                         -9.99990000e+08, -9.99990000e+08,  2.08462286e+02,  2.54322576e+01,
    ...
    rmsd_l2 = np.array([-9.99990000e+08, -9.99990000e+08, -9.99990000e+08, -9.99990000e+08,
                        -9.99990000e+08, -9.99990000e+08,  7.74945122e+00,  1.60650300e+00,
                         6.91488611e-01,  4.78944167e-01,  3.42757111e-01,  3.17814222e-01,
                         2.91292944e-01,  2.79037167e-01,  2.76532056e-01,  2.73993111e-01,
                         2.74302889e-01,  2.76287444e-01,  2.77629889e-01,  2.83291889e-01,
                         2.88522833e-01,  2.93124722e-01,  2.96310944e-01,  3.02609611e-01,
                         3.05151667e-01,  3.16696667e-01,  3.24565167e-01,  3.32604889e-01,
                         3.44917944e-01,  3.54069833e-01,  3.61391778e-01,  3.74908778e-01,
                         3.89847722e-01,  4.10146389e-01,  4.41452222e-01,  5.09782278e-01,
                         4.86964500e-01,  6.72043833e-01,  8.51752944e-01,  1.05483294e+00,
                         1.25880367e+00,  1.42147700e+00,  1.40260100e+00,  1.37121128e+00,
                         1.19757717e+00,  1.10601450e+00,  1.29353794e+00,  1.62567983e+00,
                        -9.99990000e+08, -9.99990000e+08, -9.99990000e+08, -9.99990000e+08,
                        -9.99990000e+08, -9.99990000e+08, -9.99990000e+08])
...
## =========================================================================
def _h2o_prediction(l1bradg_file=None, \
                   l1bradd_file=None, \
                   l1boa_file=None, \
                   weights_file=None, \
                   out_file=None):
    ...
    for i_lat in range ( 0, len(weights.lats) ):
        ...
        if len(ind_lat)>0:
            ...
            dummy = _ann_fit(features=x, \
                             ...
                             weights_hl3=weights.w_l3[:,:,i_lat], \
                             intercepts_hl3=weights.i_l3[:,i_lat], \
                             weights_hl4=weights.w_l4[:,:,i_lat], \
                             intercepts_hl4=weights.i_l4[:,i_lat], \
