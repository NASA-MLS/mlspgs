...
def _define_precision(surfs=None):
    ...
    rmsd_ann = np.array([-999.99, -999.99, -999.99, -999.99,
                         -999.99, -999.99, -999.99,   15.13778598,
                         11.04478292, 7.8362295, 6.64742445, 6.64881825,
                          6.75512363, 6.82766025, 6.86141564, 7.01111557,
                          7.17627366, 7.02293515, 7.2038705 , 7.48088512,
                          7.61320203, -999.99, -999.99, -999.99,
    ...
    rmsd_l2 = np.array([-9.99000000e+11, -9.99000000e+11, -9.99000000e+11, -9.99000000e+11,
                        -9.99000000e+11, -9.99000000e+11, -9.99000000e+11,  1.19772222e+01,
                         1.18848889e+01,  1.22588333e+01,  1.31036111e+01,  1.41943889e+01,
                         1.48160000e+01,  1.55303889e+01,  1.63116111e+01,  1.71353333e+01,
                         1.77469444e+01,  1.76360556e+01,  1.69901111e+01,  1.57294444e+01,
                         1.38981667e+01, -9.99000000e+11, -9.99000000e+11, -9.99000000e+11,
...
## =========================================================================
def _n2o_prediction(l1bradg_file=None, \
                   l1bradd_file=None, \
                   l1boa_file=None, \
                   weights_file=None, \
                   out_file=None):
    ...
    for i_lat in range ( 0, len(weights.lats) ):
        ...
        if len(ind_lat)>0:
            for i_surfs in range(weights.surfs[0]-1, weights.surfs[-1]):
                ...
                # are only provided for valid surfs (7:21)
...
## =========================================================================
## Run main
# Call: python n2o_prediction.py '/data/emls/nrt/v05.01.NRT.16/2022/272/MLS-Aura_L1BRADG_v05-01-NRT-16-c01_2022d272t2110.h5' '/data/emls/nrt/v05.01.NRT.16/2022/272/MLS-Aura_L1BRADD_v05-01-NRT-16-c01_2022d272t2110.h5' '/data/emls/nrt/v05.01.NRT.16/2022/272/MLS-Aura_L1BOA_v05-01-NRT-16-c01_2022d272t2110.h5' '/users/fwerner/Documents/database/neural_network_weights/weights/v05-0x/MLS-Aura_ANN-N2O_v05-0x-01_20220926.h5' '/users/fwerner/Documents/software/python/ann/test_data/MLS-Aura_N2O_v05-01-NRT-16-c01_2022d142t1410.h5'
## =========================================================================
result = _n2o_prediction(l1bradg_file=l1bradg_file, \
