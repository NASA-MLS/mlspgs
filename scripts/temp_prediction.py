...
def _define_precision(surfs=None):
    ...
    rmsd_ann = np.array([-9.99000000e+02, -9.99000000e+02, -9.99000000e+02, -9.99000000e+02,
                         -9.99000000e+02, -9.99000000e+02, -9.99000000e+02,  1.97425828e+00,
                          ...
                          4.85585083e+00, -9.99000000e+02, -9.99000000e+02, -9.99000000e+02,
                         -9.99000000e+02, -9.99000000e+02, -9.99000000e+02])

    # Here we use the annual median of precision per level, 
    # averaged over all years.
    rmsd_l2 = np.array([-9.99000000e+02, -9.99000000e+02, -9.99000000e+02, -9.99000000e+02, 
                        -9.99000000e+02, -9.99000000e+02, -9.99000000e+02, 0.6547, 
                        ...
                        3.5781, -9.99000000e+02, -9.99000000e+02, -9.99000000e+02, 
                        -9.99000000e+02, -9.99000000e+02, -9.99000000e+02])
    ...
    for i_lat in range ( 0, len(weights.lats) ):
        ...
        if len(ind_lat)>0:
            ...
            for i_surfs in range(10, weights.surfs[-1]):
                ...
                # are only provided for valid surfs (7:49)
...
## =========================================================================
## Run main
# Call: python temp_prediction.py '/data/emls/nrt/v05.01.NRT.15/2022/129/MLS-Aura_L1BRADG_v05-01-NRT-15-c01_2022d129t1410.h5' '/data/emls/nrt/v05.01.NRT.15/2022/129/MLS-Aura_L1BRADD_v05-01-NRT-15-c01_2022d129t1410.h5' '/data/emls/nrt/v05.01.NRT.15/2022/129/MLS-Aura_L1BOA_v05-01-NRT-15-c01_2022d129t1410.h5' '/users/fwerner/Documents/database/neural_network_weights/weights/v05-0x/MLS-Aura_ANN-Temperature_v05-0x-02_20210826.h5' '/users/fwerner/Documents/software/python/ann/test_data/MLS-Aura_Temp_v05-01-NRT-15-c01_2022d129t1410.h5'
## =========================================================================
