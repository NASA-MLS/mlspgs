...
\newcommand{\docname}{\bf wvs-056r2}
\newcommand{\docdate}{26 July 2007}
...
f(x) = \frac1{1 + E(1 + h \epsilon)} \text{ and }
I = \int_{x_{i-1}}^{x_i} \frac1{1 + E(1 + h \epsilon)}\, \text{d}x\,.
\end{equation}
...
\frac{\text{d}f}{\text{d}x} = \,&
  -f^2 \left( \frac{\text{d}}{\text{d}h} ( 1 + E(1 + h \epsilon)) \right)
  \frac{\text{d}h}{\text{d}x}
= -f^2 \left( \frac{\text{d}E}{\text{d}h} ( 1 + h \epsilon ) + \epsilon E
  \right)
  \frac{\text{d}h}{\text{d}x}\\
= \,& -f^2 ( \epsilon E ( 2 + h \epsilon ) ) \frac{\text{d}h}{\text{d}x}
= -f^2 x \frac{\epsilon E ( 2 + h \epsilon )}
              {h ((1+E)^2 + h \epsilon E)}
= -f^2 x \frac{\epsilon E ( 2 + h \epsilon )}
              {h (1 + E^2 + E ( 2 + h \epsilon ))}
\end{split}\end{equation}
