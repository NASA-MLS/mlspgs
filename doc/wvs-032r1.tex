...
\newcommand{\docname}{\bf wvs-032r1}
\newcommand{\docdate}{22 March 2006}
...
If the weight of a row is less than $\sqrt\epsilon$ times the largest weight
used for any previous row, where $\epsilon$ is the machine precision, there's
no point to using the row.
