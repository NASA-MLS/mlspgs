...
\newcommand{\docname}{wvs-128r5}
\newcommand{\docdate}{13 July 2016}
...
of the facet is not sufficiently small.  The maximum number of repetitions
is equal to the degree of refinement of the mesh.
...
polar vertex to the opposite edge, is 20,000/$2^l$ km.  This is always
along a meridian because the edge opposite the polar vertex is a parallel
...
\item Construct the QTM top down, starting with level 1.  If a facet has a
      point in the polygon, or the polygon has a point in that facet, or
...
\item \label{step3} When a facet is constructed, add its vertices that are
      ...
      the set.  Points of facets of the QTM at the finest level of
...
\item When a value is needed at a point specified by its longitude and
      ...
      point.  Alternatively, use the value where the line of sight
