...
S_2(\theta,r,T) &=& \sum_{j=1}^{\infty} \frac{2j+1}{j(j+1)} \left( a_j(r,T) \frac{P_j^1(\cos \theta)}{\sin \theta} + b_j(r,T) \frac{dP_j^1(\cos \theta)}{d\theta} \right),
\end{eqnarray*}
...
\subsubsection{Derivatives of Phase Function}
...
&=& \frac{1}{C(r,T)} \left( \frac{\partial p_0(\theta,r,T)}{\partial T} - p(\theta,r,T) \frac{\partial C(r,T)}{\partial T} \right) \\
...
\subsubsection{Derivatives of the Integrated Phase Function}
...
&=&  \frac{\pi}{\beta_{c\_s}} \int_0^{\infty} r^2 n(r) \xi_s(r) p(\theta,r) \left( \frac{1}{n(r)} \frac{\partial n(r)}{\partial T}  + \frac{1}{\xi_s(r)} \frac{\partial \xi_s(r)}{\partial T} + \frac{1}{p(\theta,r)} \frac{\partial p(\theta,r)}{\partial T} \right) \, dr \\ 
...
&=&  \frac{\pi}{\beta_{c\_s}} \int_0^{\infty} r^2 \frac{\partial n(r)}{\partial \IWC} \xi_s(r) p(\theta,r) \, dr \ - \ \frac{P(\theta)}{\beta_{c\_s}} \frac{\partial \beta_{c\_s}}{\partial \IWC}.
\end{eqnarray*}
...
We plug this into the right hand side of (\ref{eqn:wvs-067r3_eqn4}):
\begin{eqnarray*}
