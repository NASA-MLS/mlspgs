...
\begin{description}
\item[{\tt Do_Calc}] is a logical array indexed by the coarse path index
  that indicates that {\tt Do_Calc_FZP} is true for at least one GL point
  in the panel.  {\tt Do_Calc} might be true even if neither of the
