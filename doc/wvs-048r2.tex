...
\newcommand{\docdate}{27 October 2006}
...
The first term in the expansion of $\sec\phi-1$ is $\frac12 \phi^2$, for $\phi$
in radians, or $\frac12 \left(\frac{\pi}{180}\right)^2\phi^2 \approx
1.5\times10^{-4}\phi^2$ for $\phi$ in degrees.  The next term is
$\frac5{24}\phi^4$ for $\phi$ in radians, or
$\frac5{24}\left(\frac{\pi}{180}\right)^4\phi^4 \approx 1.9\times10^{-8}\phi^4$
for $\phi$ in degrees.  The ratio of these terms is $\approx 1.3\times 10^{-4}
\phi^2$.  Furthermore, every term is positive.  Therefore this simple quadratic
equation might not be accurate enough.  If not, its solution can still be used
as a starting point for a Newton iteration, which should therefore converge
quite quickly.  The Newton iteration should use a higher-order approximation of
$\sec\phi-1$ instead of using $\sec\phi-1$ to avoid cancellation.  The first
three terms in the Taylor series for $\sec\phi-1$ are $\frac12 \phi^2 +
\frac5{24} \phi^4 + \frac{61}{720} \phi^6$.
