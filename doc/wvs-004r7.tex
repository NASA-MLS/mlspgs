...
This may seem wasteful of space~-- space is reserved for 32 uninteresting
(indeed impossible) fields~-- but it is less space than would be consumed
by the instructions to initialize the local variables, say {\tt
molecule}, to impossible values, say zero, and check each one
individually with, say {\tt if ( mole\-cule /= 0 ) call announce\_error
....}
