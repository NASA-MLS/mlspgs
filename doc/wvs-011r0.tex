...
\newcommand{\ps@twolines}{%
  \renewcommand{\@oddhead}{%
    10 January 2001\hfill Page \thepage\ of \pageref{lastpage}\hfill{\bf
    wvs-011}}%
...
\left [
  \begin{array}{c}
    {\bf 0}\\
    {\bf \hat b_2}
  \end{array} \right ] = {\bf \hat b_2^T b_2} = r^2
$$
...
Now consider the Cholesky factor $\hat U$ of $\hat A$, i.e. $\hat U^T
