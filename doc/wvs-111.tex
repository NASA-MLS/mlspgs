...
\newcommand{\docname}{wvs-111}
\newcommand{\docdate}{30 August 2012}
...
Newton moves.  Another is that the Jacobian is ill conditioned.  Forcing a
minimum value for $\lambda$ improves the condition.
