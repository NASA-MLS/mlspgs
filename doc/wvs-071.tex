...
% -----------------------------------------------------------------------------
%
\slidetitle[Quantities]{Quantities to be computed}
...
\end{equation}
%
$N_1$, $N_2$, $\alpha$, $\mu$ and $\sigma$ depend upon temperature and IWC,
but not on $\theta$ or $r$.
%
\clearpage
%
% -----------------------------------------------------------------------------
%
\slidetitle[Efficiencies]{Mie efficiencies}
...
% -----------------------------------------------------------------------------
%
\slidetitle[Hankel]{The Bessel and Hankel functions}
%
...
% -----------------------------------------------------------------------------
%
\slidetitle{The Bessel and Hankel functions (cont.)}
...
% -----------------------------------------------------------------------------
%
\slidetitle[Phase]{The integrated phase function}
%
...
% -----------------------------------------------------------------------------
%
\slidetitle[Legendre]{The associated Legendre function}
%
...
% -----------------------------------------------------------------------------
%
\slidetitle[Quadrature]{Quadratures}
%
...
% -----------------------------------------------------------------------------
%
\slidetitle[Results]{Plots of $P(\theta)$}
%
...
{\parskip 0pt\hfill\includegraphics[scale=0.65,angle=90]{./wvs-071-plot.eps}\hfill}
...
% -----------------------------------------------------------------------------
%
\slidetitle[Derivatives]{Derivatives}
%
