...
\newcommand{\docname}{\bf wvs-094}
\newcommand{\docdate}{5 May 2010}
...
All input uses Fortran NAMELIST, with name IN.  Each namelist block
begins on a new line, with an ampersand followed by the namelist name
(case insensitive), i.e., in this case {\tt \&in}, followed by \emph{name
...
nFunc(:,:,:,:,:) & Quadrature status flags and numbers of integrand values.
          ...
          for the number of integrand values and 2 is for the quadrature
