...
!   Real(r4), intent(in) :: PFA_BETA_COEFF(N2lvl,maxaitkenpts,maxpfach,*)
    Real(r4), intent(in) :: PFA_BETA_COEFF(N2lvl,maxaitkenpts,2,*)
...
!   Real(r4), intent(in) :: BETA_T_POWER(N2lvl,maxaitkenpts,maxpfach,*)
    ...
    Real(r4), intent(out) :: DELTA(2*Nlvl,Nc,mnp,*)
