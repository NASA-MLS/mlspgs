...
!===============================================================================
module SDPToolkit               ! A minimal substitute SDP Toolkit.
!===============================================================================
...
! This module contains constants and procedures to substitute
! for the real SDPToolkit module. The similar SDPToolkitSubstitute.f90
! is not a module and so cannot perform this duty.

! To use this
! cp lib/PseudoToolkit.f90 lib/SDPToolkit.f90
! make update
! make install-l2

! We didn't test to see whether l1 and the other tools will build
! properly.

! Why substitute for the real toolkit? In testing a code change or a
! new compiler, you may encounter an internal compiler error or a bogus
! error message that you wish to show the compiler's maker. Often, they
! will ask for a minimal set of code that displays the error. You'll
! prefer not to send them the whole shrinkwrap, and they'll thank you
! for such restraint, so one bundle of thorny code you can now omit is
! the actual toolkit.
...
!  include 'PGS_IO.f'
  ...
  integer, parameter :: PGSMET_W_METADATA_NOT_SET = 2
  integer, parameter :: PGSPC_W_NO_REFERENCE_FOUND = 2
  integer, parameter :: pgsd_pc_uref_length_max = 1024
  ! include 'PGS_IO_1.f'
  integer, parameter :: PGSD_IO_GEN_ASEQFRM = 1001
  integer, parameter :: PGSD_IO_GEN_ASEQUNF = 1002
  integer, parameter :: PGSD_IO_GEN_RDIRFRM = 1003
  integer, parameter :: PGSD_IO_GEN_RDIRUNF = 1004
  integer, parameter :: PGSD_IO_GEN_RSEQUNF = 1005
  integer, parameter :: PGSD_IO_GEN_UDIRFRM = 1006
  integer, parameter :: PGSD_IO_GEN_UDIRUNF = 1007
  integer, parameter :: PGSD_IO_GEN_USEQFRM = 1008
  integer, parameter :: PGSD_IO_GEN_USEQUNF = 1009
  integer, parameter :: PGSD_IO_GEN_WDIRFRM = 1010
  integer, parameter :: PGSD_IO_GEN_WDIRUNF = 1011
  integer, parameter :: PGSD_IO_GEN_WSEQFRM = 1012
  ...
  ! include 'PGS_PC_9.f'
  ! include 'PGS_SMF.f'
  integer, parameter :: PGS_SMF_MASK_LEV_N = 1
  integer, parameter :: PGS_SMF_MASK_LEV_E = 2
  integer, parameter :: PGS_SMF_MASK_LEV_F = 3
  integer, parameter :: PGS_SMF_MASK_LEV_W = 4
  integer, parameter :: PGS_SMF_MASK_LEV_M = 5
  integer, parameter :: PGS_SMF_MASK_LEV_S = 6
...
!  include 'PGS_DEM.f'
  integer, parameter :: PGSD_DEM_30ARC = 0
  integer, parameter :: PGSD_DEM_60ARC = 1
  integer, parameter :: PGSD_DEM_90ARC = 2
  integer, parameter :: PGSD_DEM_ELEV = 2
  integer, parameter :: PGSD_DEM_WATER_LAND = 2
  integer, parameter :: PGSd_DEM_geoid = 2
  integer, parameter :: PGSd_DEM_degree = 2
