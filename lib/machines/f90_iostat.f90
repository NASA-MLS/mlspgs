!  f90_iostat.f90
!
!  Module defining the run-time IOSTAT values returned by
!  the NAGWare f90 Compiler.
!
!  Copyright 1991-2000 The Numerical Algorithms Group Ltd., Oxford, U.K.
!
...
!
    integer, parameter :: IOERR_EOR                       =  -2             
    integer, parameter :: IOERR_EOF                       =  -1
