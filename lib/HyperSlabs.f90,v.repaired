...
!                     i.e. Gather (optionally allocates slab first)
...
!
! $Log$
! Revision 2.4  2021/05/13 23:32:54  pwagner
! Note that it might be better to rename two routines Gather and Scatter
!
