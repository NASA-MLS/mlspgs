...
!     number of subroutines that compute Fourier transforms.
...
#if defined NAG
      real(rk), intent(inout) :: AR(*), AI(*), S(*) ! (2**m)
#elif defined LF95
...
! $Log$
! Revision 2.1  2007/06/08 22:08:53  vsnyder
! Replace dfft_m.f90 with dfft_m.F90
!
! Deleted dfft_m.f90 to replace it with dfft_m.F90
!
