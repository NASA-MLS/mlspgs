...
# 'no stars => amateur (night)' is the mnemonic
#
# Usage:
# amateur.sh [opt] ..  [arg1 arg2 ..]
#
#    O p t i o n s
...
# then
#    `amateur *.b *.c`       returns "a.b"
#    `amateur *.d`           returns ""
#    `amateur -nf *.d`       returns "c.d e.d"
#    `amateur -x *`          returns "f.7"
#    `amateur -glob *.7`     returns "" 
#    `amateur -glob *.8`     returns "*.8" 
# 
# --------------- End amateur.sh help
