...
!
    ...
    real(r8), intent(out) :: BETA_COEFF, T_POWER, DBETA_COEF_DW
    real(r8), intent(out) :: DBETA_COEF_DN, DBETA_COEF_DNU0
!
! -----     Local variables     ----------------------------------------
!
    ...
    Real(r8), Parameter :: TINY = 1.0e-14
...
!
   ...
   &       mdb_pres,mdb_temp,x_grid,x2nu(ln_i),                &
...
!
    real(r8), intent(in) :: MDB_PRES(*), MDB_TEMP(*)
