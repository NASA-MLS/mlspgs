...
! -----     Private data     -------------------------------------------
  real(r8), save :: ABLEN              ! Half-Length of A-B interval
  real(r8), save :: ABMID              ! Midpoint of A-B interval
...
! =============================================     QUAD_START     =====
  ...
  ! quadrature.
    real(r8), intent(in) :: A, B       ! Limits of interval
    integer(i4), intent(out) :: WHAT   ! What to do?  See usage below
    real(r8), intent(out) :: X         ! Abscissa at which to evaluate F
    real(r8), intent(out) :: INTEGRAL  ! Value of integral -- set to zero
  ! Usage:
...
! ===================================================     QUAD     =====
  ...
  ! Gauss-Legendre quadrature.
    real(r8), intent(in) :: F           ! Value of F at X
    integer(i4), intent(inout) :: WHAT  ! What to do?  See usage below
    real(r8), intent(out) :: X          ! Abscissa at which to evaluate F
    real(r8), intent(inout) :: INTEGRAL ! Value of the integral
