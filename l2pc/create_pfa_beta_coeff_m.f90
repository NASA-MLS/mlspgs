...
contains
 ...
 &           pfa_dbeta_dw, pfa_dbeta_dn, pfa_dbeta_dnu, beta_t_power )
    ...
    real(r8), intent(in) :: Z_PATH(*), T_PATH(*)
...
!   real(r8), intent(out) :: PFA_BETA_COEFF(N2lvl,maxaitkenpts,maxpfach,*)
    real(r8), intent(out) :: PFA_BETA_COEFF(N2lvl,maxaitkenpts,2,*)
!   Real(r8), intent(out) :: PFA_DBETA_DW(N2lvl,maxaitkenpts,maxpfach,*)
    Real(r8), intent(out) :: PFA_DBETA_DW(N2lvl,maxaitkenpts,2,*)
!   Real(r8), intent(out) :: PFA_DBETA_DN(N2lvl,maxaitkenpts,maxpfach,*)
    Real(r8), intent(out) :: PFA_DBETA_DN(N2lvl,maxaitkenpts,2,*)
!   Real(r8), intent(out) :: PFA_DBETA_DNU(N2lvl,maxaitkenpts,maxpfach,*)
    Real(r8), intent(out) :: PFA_DBETA_DNU(N2lvl,maxaitkenpts,2,*)
!   Real(r8), intent(out) :: BETA_T_POWER(N2lvl,maxaitkenpts,maxpfach,*)
    Real(r8), intent(out) :: BETA_T_POWER(N2lvl,maxaitkenpts,2,*)
!
! -----     Local variables     ----------------------------------------
!
    Real(r8) :: Freq
