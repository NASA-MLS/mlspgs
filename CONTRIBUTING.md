...
Within your local development environment, this is the stage at which you'll propose your changes, and commit those changes back to version control. See the [DEPENDENCIES.md](DEPENDENCIES.md) and [MakeFC.md](MakeFC.md) for more specifics on what you'll need as prerequisites to setup your local development environment.
...
Report your security vulnerabilities to [Nathaniel Livesey](https://github.com/njlivesey).
...
- Code compilation documentation
  - [DEPENDENCIES.md](DEPENDENCIES.md) - information on how to set up your development environment, including necessary dependencies
  - [MakeFC.md](MakeFC.md) - how to build a configurable Makefile for this project
  - `docs` Folder - documentation collected over the years about the project background and methods
...
- **MLS** - acronym, all capital letters
