# MLSPGS Project Governance

This governance model aims to create an open source community that encourages transparency, contributions, and collaboration, but maintains sound technical and quality standards. Our goal is to build a community comprised of members across the MLSPGS community and beyond, including from private organizations, universities, government organizations, and international organizations. 
...
Anyone who has downloaded, deployed, or operated MLSPGS to meet a specific objective. This project was primarily designed for generating Aura Microwave Limb Sounder mission Level 1 and Level 2 data products, but let us know if you've found other uses for it.  
...
Overall manager of the project with final authority over all key decisions. Currently these are the MLSPGS developers. They will serve in the Product Manager role through the end of the Aura MLS mission and be the final authortiy on decisions. After that time, roles for this may be reassessed.
