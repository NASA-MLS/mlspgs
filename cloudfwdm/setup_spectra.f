...
C -------------------------------------------------------------
     ...
     >     N_O2_LINES
      ...
      write(9,'(4x,5f6.2)') (n2(i), 
     >   i=1, N_O2_LINES)

      write(9,'(4x,5f6.2)') (n2(i), 
     >   i=N_O2_LINES+1, N_O2_LINES+N_H2O_LINES)

      write(9,'(4x,5f6.2)') (n2(i), 
     >   i=N_O2_LINES+N_H2O_LINES+1, 
     >     N_O2_LINES+N_H2O_LINES+N_O18O_LINES )

      write(9,'(4x,5f6.2)') (n2(i), 
     >   i=N_O2_LINES+N_H2O_LINES+N_O18O_LINES+1,
     >     N_O2_LINES+N_H2O_LINES+N_O18O_LINES+N_H2O18_LINES)

      write(9,'(4x,5f6.2)') (n2(i), 
     >   i=N_O2_LINES+N_H2O_LINES+N_O18O_LINES+N_H2O18_LINES+1,
     >     N_O2_LINES+N_H2O_LINES+N_O18O_LINES+N_H2O18_LINES+N_O3_LINES)
